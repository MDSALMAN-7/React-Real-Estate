...
export function Navbar(){
    ...
    return(
        <div className="absolute top-0 left-0 w-full z-10">
            ...
            <div className={`md:hidden ${showMobileMenu ? 'fixed w-full h-full':'h-0 w-0'}  right-0 top-0 botton-0 overflow-hidden bg-white transition-all`}>
                ...
                <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
                    ...
                    <a onClick={()=> setMobileMenu(false)}  href="#Project" className='px-4 py-2 rounded-full inline-block'>Project</a>
